...
func (s *Server) RegisterRoutes() http.Handler {
	...
	mux.HandleFunc("GET /v1/users/mutual/{username}", userHandler.FindAllMutualUsers)
	mux.HandleFunc("GET /v1/user/{username}", userHandler.FindOneUser)
	mux.HandleFunc("PATCH /v1/user", userHandler.UpdateUser)
	mux.HandleFunc("DELETE /v1/user/logout", userHandler.Logout)
	mux.HandleFunc("DELETE /v1/user", userHandler.DeleteUser)
	...
	mux.HandleFunc("GET /v1/contents", contentHandler.GetAllContent)
	mux.HandleFunc("GET /v1/contents/following", contentHandler.GetAllContentByFollowing)
	...
	mux.HandleFunc("GET /v1/saves", saveHandler.GetAllSaves)
	mux.HandleFunc("DELETE /v1/save/{saveId}", saveHandler.UnsaveContent)

	mux.HandleFunc("POST /v1/feedback", feedbackHandler.SendFeedback)
	...
	mux.HandleFunc("/ws/group/{groupId}", groupChatHandler.HandleWebSocket)
	mux.HandleFunc("GET /v1/groups", groupChatHandler.GetAllGroupChats)
	...
	mux.HandleFunc("DELETE /v1/group/member/{groupId}", groupChatHandler.LeaveGroupChat)
	mux.HandleFunc("DELETE /v1/group/{groupId}", groupChatHandler.DeleteGroupChat)

	mux.HandleFunc("POST /v1/ai/conv", aIConversationHandler.CreateConversation)
	mux.HandleFunc("GET /v1/ai/conv", aIConversationHandler.GetConversation)
	...
	mux.HandleFunc("DELETE /v1/notification", notificationHandler.DeleteNotifications)
