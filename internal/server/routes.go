...
func (s *Server) RegisterRoutes() http.Handler {
	...
	mux.HandleFunc("OPTIONS /user/update", userHandler.UpdateUser)
	mux.HandleFunc("DELETE /user/logout", userHandler.Logout)
	mux.HandleFunc("OPTIONS /user/logout", userHandler.Logout)
	...
	mux.HandleFunc("OPTIONS /content/findone", contentHandler.GetOneContent)
	...
	mux.HandleFunc("OPTIONS /save/create", saveHandler.SaveContent)
	mux.HandleFunc("GET /save/findall", saveHandler.GetAllSaves)
	mux.HandleFunc("OPTIONS /save/findall", saveHandler.GetAllSaves)
	mux.HandleFunc("GET /save/findone", saveHandler.GetOneSave)
	mux.HandleFunc("OPTIONS /save/findone", saveHandler.GetOneSave)
	mux.HandleFunc("DELETE /save/delete/{id}", saveHandler.UnsaveContent)
	mux.HandleFunc("OPTIONS /save/delete/{id}", saveHandler.UnsaveContent)
	...
	mux.HandleFunc("OPTIONS /message/create", messageHandler.SendMessage)
	...
	mux.HandleFunc("PUT /ai/message/update", aiMessageHandler.UpdateMessage)
	...
	mux.HandleFunc("OPTIONS /notification/findall", notificationHandler.GetAllNotifications)
